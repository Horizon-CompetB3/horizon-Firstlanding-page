...
<section id="section-first">
  <header>
    <div class="logo-bananart"><img src="img/logo_bananart_blanc.png"></div>
...
<section id="artiste" class="artiste">
  ...
  <div class="div-content">
    ...
    <div class="div-text">
      ...
      <input class="input-text" placeholder="Nom" type="text"></br>
      <input class="input-text" placeholder="email" type="text"></br>
      <input class="submit" type="submit">
      </div>

      <div class="reseaux">
        <a href=""><img src="img/twitter.png" alt="twitter" class="icon-reseaux"></a>
        <a href=""><img src="img/facebook.png" alt="facebook" class="icon-reseaux"></a>
        <a href=""><img src="img/instagram.png" alt="instagram" class="icon-reseaux"></a>
        <a href=""><img src="img/linkedin.png" alt="linkedin" class="icon-reseaux"></a>
      </div>
      <div>
  ...
  <div class="div-content">
    ...
    <div class="div-text">
      ...
      <div class="div-description">
        ...
        En cédant vos rebuts vous faciliterai ainsi le travail des artistes tout en vous débarrassant de vos rebuts et surplus.<br/><br/><br/>
        Tenez-vous au courant en vous inscrivant à la Newsletter !</p>
      </div>
      <div class="formulaire">
      <input class="input-text" placeholder="Nom" type="text"></br>
